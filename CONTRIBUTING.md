# Contributing to mtl-ddexvalidator
...
1. Check existing [issues](https://github.com/musictechlab/mtl-ddexvalidator/issues)
   to avoid duplicates
...
Open a [discussion](https://github.com/musictechlab/mtl-ddexvalidator/discussions)
